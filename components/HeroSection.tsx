...
export default function HeroSection() {
    ...
    // Motion values for cursor-based parallax
        ...
        >
            ...
            >
                <motion.h1
                    ...
                    className="text-3xl md:text-6xl font-extrabold leading-tight tracking-tight
                     text-white hover:cursor-pointer transition-transform duration-300"
                >
                    {"Hello from there, we are not a company"
                        .split("")
                        .map((l, i) => (
                            <motion.span
                                key={i}
