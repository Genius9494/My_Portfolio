...
export default function MyInformation() {
    ...
    // يجب إنشاؤها خارج useEffect
    const offsetX = useTransform(mouseX, [0, 1000], [-15, 15]);
    const offsetY = useTransform(mouseY, [0, 1000], [-15, 15]);
    ...
    // لا نعرض شيئًا قبل تحميل العميل لمنع مشاكل الـ hydration
